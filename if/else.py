...
# The else statement provides a default action when none of the previous conditions are true. Think of it as a "catch-all"
# for any scenario not covered by your if and elif statements.
...
# The else statement acts as a fallback that executes when none of the preceding conditions are true. This makes it useful
# for error handling, validation, and providing default values.
